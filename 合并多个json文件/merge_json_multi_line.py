...
# originFileListPath = "H:\scrapy_learning_workSpace\MergeJson\merchantPage201609291645\merchantPage1"
...
def formatJson(line):
    return  json.dumps(json.loads(line,"utf-8",strict=False),indent=4, sort_keys=False, ensure_ascii=False)
